...
def main():
    ...
    mq_circuit = xxzz_qubit(d=lattice_sizes[-1]).circ
    ...
    plot_minimum_inj_qubits(concatenated_df, get_decoded_logical_error_xxzz, threshold_min=0.01, threshold_catasptrophic=0.25)
